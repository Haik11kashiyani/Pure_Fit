    ...
    <div class="row justify-content-center">
        <div class="col-12 col-lg-8 px-3">
            ...
            <div class="text-center mb-5">
                <div class="mb-4">
                    <i class="fas fa-check-circle fa-5x" style="color: #636B2F;"></i>
                </div>
                <h1 class="display-5 fw-bold mb-3" style="color: #3D4127;">
                    Order Placed Successfully!
                </h1>
                
                <?php if ($order['payment_method_id'] == 1): // COD ?>
                <div class="alert alert-info mb-4 mx-auto" style="max-width: 600px; background: rgba(212, 222, 149, 0.2); border: 2px solid #D4DE95; color: #3D4127;">
                ...
                <p class="lead mb-4" style="color: #636B2F;">
                ...
                <div class="card-body p-3 p-md-4">
                    <div class="row g-3 mb-4">
                        <div class="col-12 col-md-6">
                            <p class="mb-1 small" style="color: #636B2F;">Order Date:</p>
                            <p class="mb-0 fw-bold" style="color: #3D4127;"><?php echo date('d M Y, h:i A', strtotime($order['created_at'])); ?></p>
                        </div>
                        <div class="col-12 col-md-6">
                            <p class="mb-1 small" style="color: #636B2F;">Total Amount:</p>
                            <p class="mb-0 fw-bold h5" style="color: #636B2F;">₹<?php echo number_format($order['total_amount'], 2); ?></p>
                        </div>
                        <div class="col-12 col-md-6">
                            <p class="mb-1 small" style="color: #636B2F;">Payment Method:</p>
                            <p class="mb-0 fw-bold" style="color: #3D4127;">
                                <?php echo ($order['payment_method_id'] == 1) ? 'Cash on Delivery' : 'Online Payment'; ?>
                            </p>
                        </div>
                        <div class="col-12 col-md-6">
                            <p class="mb-1 small" style="color: #636B2F;">Order Status:</p>
                            <?php
                            $status_colors = [
                        ...
                        <div class="col-12 col-md-6">
                            <p class="mb-1 small" style="color: #636B2F;">Payment Status:</p>
                            <?php
                            $payment_colors = [
                                'pending' => 'background: #ffc107; color: #856404;',
                            ...
                            $payment_style = $payment_colors[$order['payment_status']] ?? 'background: #D4DE95; color: #3D4127;';
                            ?>
                ...
                <div class="card-body p-3 p-md-4">
                    ...
                    <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                        ...
                        <div class="flex-grow-1">
                            <h6 class="mb-1 fw-bold" style="color: #3D4127;"><?php echo htmlspecialchars($item['name']); ?></h6>
                            <p class="mb-0 small" style="color: #636B2F;">
                                Quantity: <?php echo $item['quantity']; ?> × ₹<?php echo number_format($item['price'], 2); ?>
                            </p>
                        </div>
                        <span class="fw-bold" style="color: #636B2F;">₹<?php echo number_format($item_total, 2); ?></span>
                    </div>
                    <?php endforeach; ?>
                </div>
            </div>
            ...
            <div class="text-center">
                <a href="index.php" class="btn btn-lg px-5 py-3 rounded-pill text-white fw-bold me-2 mb-2" style="background: linear-gradient(135deg, #636B2F, #3D4127); border: none;">
                    <i class="fas fa-home me-2"></i>Continue Shopping
                </a>
                <a href="profile.php" class="btn btn-lg px-5 py-3 rounded-pill fw-bold mb-2" style="background: #f8f9fa; color: #636B2F; border: 2px solid #D4DE95;">
